...
export default function POSView({ user }: POSViewProps) {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-5">
      ...
      {/* RIGHT COLUMN: Order Cart & Checkout Drawer (5 cols on desktop) */}
      <div className="lg:col-span-5 space-y-4">
        ...
        >
          ...
          <div className="flex items-center justify-between pb-3 border-b border-gray-100">
            <div className="flex items-center space-x-2">
              ...
              <h3 className="text-sm font-black text-gray-950 uppercase tracking-wide">
                Hóa Đơn Thanh Toán ({cart.length})
              </h3>
            </div>
            {cart.length > 0 && (
              <button
          ...
          <div className="pt-1">
            {tradeInItem ? (
              ...
              >
                ...
                <span>+ Thêm Máy Thu Cũ Đổi Mới (Trade-In)</span>
              </button>
            )}
          </div>
          ...
          <div className="p-3.5 bg-gray-50 border border-gray-200 rounded-2xl space-y-2.5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
              <div>
                <input
                  ...
                  className="w-full px-3 py-2 bg-white border border-gray-300 rounded-xl text-xs font-bold focus:ring-2 focus:ring-gray-900 focus:outline-none"
                  required
                />
              </div>
              <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
              <input
                ...
                className="w-full px-3 py-1.5 bg-white border border-gray-300 rounded-xl text-[11px] focus:ring-2 focus:ring-gray-900 focus:outline-none"
              />
              <input
                type="text"
                value={customerCccd}
                onChange={(e) => setCustomerCccd(e.target.value)}
                placeholder="Số CCCD (Lưu bảo hành)"
                className="w-full px-3 py-1.5 bg-white border border-gray-300 rounded-xl text-[11px] font-mono focus:ring-2 focus:ring-gray-900 focus:outline-none"
              />
            </div>
          </div>
          ...
          <button
            ...
            className="w-full py-3.5 bg-gray-950 hover:bg-black text-white rounded-2xl text-sm font-black shadow-lg shadow-gray-900/20 flex items-center justify-center space-x-2 transition disabled:opacity-50 disabled:cursor-not-allowed"
          >
